    ...
    const fetchBusinesses = async () => {
      try {
        ...
        if (businessesData.length > 0) {
          ...
          const derivedCategories: Category[] = Array.from(categoryMap).map(
            ([name, count]) => ({
              name,
              count,
            })
        ...
        setError(
          "Impossible de charger les commerces. Veuillez réessayer plus tard."
        );
      } finally {
        setIsLoading(false);
      }
      ...
      <div className="bg-white py-20 text-center">
        <div className="container mx-auto px-4">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            Trouvez les meilleures adresses près de chez vous grâce aux avis de
            notre communauté
          </p>
